...
- El mordisco usa el BBA del amo, la Destreza del cuervo y el modificador de tamaño `Tiny`.
...
| CA | `16 / 16 / 14` | `19 / 14 / 17` | El cuervo base es `Tiny` (+2) y a nivel 9 recibe `+5` de armadura natural adicional. |
| Ataque base | `+2` | `+4` | El familiar usa el BBA del amo. |
| Mordisco | `+4 (1d3-4)` | `+8 (1d3-4)` | Usa el BBA del amo, la Destreza del cuervo y el modificador de tamaño `Tiny`. |
...
| Maniobras | `BMC 2, DMC 10` | `BMC 4, DMC 10` | Las criaturas `Tiny` usan Destreza para BMC y aplican el modificador especial de tamaño `-2`. |
